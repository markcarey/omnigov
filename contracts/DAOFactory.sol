...
contract DAOFactory is Initializable {
    ...
    function createGoverance(address token, bool vetoable, uint256 votingPeriod) external returns(address) {
        ...
        address lzEndpoint = 0x79a63d6d8BBD5c6dfc774dA79bCcD948EAcb53FA; // Rinkeby TODO: change this!!
        governor.initialize(ERC20VotesUpgradeable(token), lzEndpoint, votingPeriod);
