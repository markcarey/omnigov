...
const { API_URL, MUMBAI_API_URL, POLYGON_API_URL, OPTIKOVAN_API_URL, PRIVATE_KEY, ETHERSCAN_API_KEY, POLYSCAN_API_KEY, OPTISCAN_API_KEY } = process.env;
module.exports = {
  solidity: {
    compilers: [
      {
